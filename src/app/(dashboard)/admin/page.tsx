...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-slate-700 to-slate-900 p-8 text-white">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {actions.map((action) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-lg bg-linear-to-br ${action.color} flex items-center justify-center shrink-0`}
              >
