...
export default function QuizResultContent({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div
        className={`relative overflow-hidden rounded-2xl p-8 text-white text-center ${isPassed ? "bg-linear-to-r from-green-500 to-emerald-600" : "bg-linear-to-r from-red-500 to-rose-600"}`}
      >
